...
for IMAX in 255 65565; do
  for OMP_THREADS in 2 4 8 16 32 64 128; do
    ...
    echo "Running with OMP_NUM_THREADS=${OMP_THREADS}"
      ...
      # Example: 1800x1169 pixels (resolution of my MacBook), complex plane region [-2.0,1.0]x[-1.0,1.0] and I_max=255.
      RESULT=$(./mandelbrot_weak $((1800 * OMP_THREADS)) $((1169 * OMP_THREADS)) -2.0 -1.0 1.0 1.0 ${IMAX})
